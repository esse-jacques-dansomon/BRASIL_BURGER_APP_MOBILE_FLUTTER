...
class MenuAppScreen extends StatefulWidget {
  const MenuAppScreen({Key? key}) : super(key: key);

  @override
  State<MenuAppScreen> createState() => _MenuAppScreenState();
}

class _MenuAppScreenState extends State<MenuAppScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: getAppBar(context),
      bottomNavigationBar: const CustomNavBar(menu: true),
      body: SafeArea(
        child: Column(
          children: [
        ...
        SizedBox(
          ...
          child: Align(
            ...
            child: Container(
              ...
              child: Image.asset(
                AppHelper.getAssetName("next_filled.png", "images/virtual"),
              ),
            ),
          ),
        ),
